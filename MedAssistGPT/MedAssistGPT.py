...
TRAINING_CONFIG = {
    ...
    "max_steps": 150_000,        # CHANGED: ~13B tokens, plenty for this model
    "eval_freq": 2000,
    "eval_iter": 200,
    "save_freq": 5000,
...
DATA_CONFIG = {
    "dataset_name": "japhba/pubmed_simple",  # CHANGED: Better quality QA dataset
...
WANDB_CONFIG = {
    "project": "MedAssistGPT-Pretraining-Final",
    "entity": "kunjcr2-dreamable",  # Your wandb username
    "name": "medassist-final",
}
...
checkpoint_file_path = Path("checkpoints/checkpoint_step_215.pt")
